    ...
    <div class="center" id="phy">
        <ul>
            <li class="mod" id="mod1">
                ...
                <ul class="drop1">
                    <li id="oneOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod1s.pdf" target="_"><button
            ...
            <li class="mod" id="mod2">
                ...
                <ul class="drop1">
                    <li id="twoOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod2s.pdf" target="_"><button
                                style="background-color: #f70801;">view</button></a><a><button
            ...
            <li class="mod" id="mod3">
                ...
                <ul class="drop1">
                    <li id="threeOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod3s.pdf" target="_"><button
                                style="background-color: #f70801;">view</button></a><a><button
            ...
            <li class="mod" id="mod4">
                ...
                <ul class="drop1">
                    <li id="fourOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod4s.pdf" target="_"><button
                                style="background-color: #f70801;">view</button></a><a><button
            ...
            <li class="mod" id="mod5">
                ...
                <ul class="drop1">
                    <li id="fiveOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod5s.pdf" target="_"><button
                                style="background-color: #f70801;">view</button></a><a><button
            ...
            <li class="mod" id="mod6">
                ...
                <ul class="drop1">
                    <li id="sixOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod6s.pdf" target="_"><button
                                style="background-color: #f70801;">view</button></a><a><button
            ...
            <li class="mod" id="mod7">
                ...
                <ul class="drop1">
                    <li id="sevenOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod7s.pdf" target="_"><button
                                style="background-color: #f70801;">view</button></a><a><button
            ...
            <li class="mod" id="mod8">
                ...
                <ul class="drop1">
                    <li id="eightOne">
                        <p>500/-</p> <a href="../html/pdfopener.php?pdf=../pdfs/eee/eeemod8s.pdf" target="_"><button
                                style="background-color: #f70801;">view</button></a><a><button
        ...
        <div class="side">
            ...
            <span id="sum">
                <p>total: 0/-</p>
                <a><button onclick="sendTotalPriceEee()">Pay</button></a>
            </span>
        </div>
